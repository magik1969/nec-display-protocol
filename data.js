const parameters =[
    ...
    {name: 'input', code: '0060', wDuration: 7000, mode: 'rw', dic:[
        ['VGA', 1],
        ['RGBHV', 2],
        ['DVI', 3],
        ['Option', 13],
    ...
    {name: 'backlight', code: '0010', mode: 'rw', min: 0, max: 100},
    // Set/get picture contrast if SpectraView if off
    {name: 'contrast', code: '0012', mode: 'rw', min: 0, max: 100},
    // Set/get picture brightness if SpectraView if off
    {name: 'brightness', code: '0092', mode: 'rw', min: 0, max: 100},
    /*
    ...
    {name: 'colorTemp', code: '0054', mode: 'rw', min: 0, max: 74,
    ...
    {name: 'matrixMode', code: '02D3', mode: 'rw', dic:[['off', 1], ['on', 2]]},
    //  Set/get tile compensation for tile/matrix mode
    {name: 'tileComp', code: '02D5', mode: 'rw', dic:[['off', 1], ['on', 2]]},

    //DISPLAY PROTECTION
    //  Set/get current temperature sensor
    {name: 'tempSensor', code: '0278', mode: 'rw', dic: [['sensor1', 1], ['sensor2', 2], ['sensor3', 3]]},
    ...
    {name: 'fan', code: '027A', mode: 'rw', dic:[['fan1', 1], ['fan2', 2], ['fan3', 3]]},
    ...
    {name: 'fanControl', code: '027D', mode: 'rw', dic: [['auto', 1], ['on', 2]]},
    //  Set/gat carrent fan speed mode. Example: 'fanSpeed low' 'fanSpeed ?'
    {name: 'fanSpeed', code: '103F', mode: 'rw', dic: [['high', 1], ['low', 2]]},

    //AUDIO
    //  Set/get audio volume  
    {name: 'volume', code: '0062', mode: 'rw', min: 0, max: 100},
    // Mute/unmute audio
    {name: 'mute', code: '008D', mode: 'rw', dic: [['off-set', 0], ['on', 1], ['off', 2]]}
]
...
const commands = [
    ...
    {name: 'SN', mode: 'r', msg: '\x02C216\x03', replypatt: /C316([A-F0-9]+)/, valDecode: function(str){return asciiHex2str(str)}},
    {name: 'model', mode: 'r', msg: '\x02C217\x03', replypatt: /C317([A-F0-9]+)/, valDecode: function(str){return asciiHex2str(str)}},
    // Get diagnosis status from the display. Example: 'diagnosis' 
    {name: 'diagnosis', mode: 'r',msg: '\x02B1\x03', replypatt: /A1([A-F0-9]+)/, dics:[
        ['normal', 0],
